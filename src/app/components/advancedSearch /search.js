...
// import AdapterJalali from "../reports/DatePickerWrapper/DatePickerWrapper";
//
// export default function AdvancedSearch({fields}) {
//
//     fields.map((field)=>{
//         switch (field.filterType) {
//             case 'date':return<AdapterJalali  label={field.label}  value={field.value} setValue={field.setValue}/>;
//
//         }
//
//     })
